...
public class Gui extends javax.swing.JFrame {
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        for (Mines m : Mines.values()) {
            if (((String) jComboBox2.getSelectedItem()).equalsIgnoreCase(m.name())) {
                mine = m;
            }
        }
        if (mine == null) {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        for (Rocks ores : Rocks.values()) {
            if (((String) jComboBox1.getSelectedItem()).equalsIgnoreCase(ores.toString())) {
                ore = ores;
                break;
            }
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Furnaces m : Furnaces.values()) {
            if (((String) smeltLocation.getSelectedItem()).equalsIgnoreCase(m.name())) {
                mine = m;
                break;
            }
        }
        ...
        System.out.println("Setting up smelting with furnace " + mine.name() + " and bar type " + bar.name());
